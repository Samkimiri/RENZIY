          ...
          >
            ...
            {method === 'M-Pesa' ? (
              ...
              <form onSubmit={triggerPaymentProcessing} className="space-y-5">
                ...
                <button 
                  type="submit"
                  className="w-full bg-[#006c45] text-white py-4 rounded-xl font-bold hover:brightness-105 active:scale-95 transition-all text-sm mt-4 shadow-sm"
                >
                  Send STK Push
                </button>
              </form>
        ...
        {step === 'processing' && (
          ...
          >
            ...
            <div className="relative w-36 h-36 mx-auto mb-6 flex items-center justify-center">
              <div className="absolute inset-0 rounded-full border-1 border-dashed border-[#006c45]/20 animate-spin" style={{ animationDuration: '24s' }} />
              <div className="absolute w-28 h-28 rounded-full border-2 border-[#002645] border-t-transparent animate-spin" />
              <div className="absolute w-20 h-20 rounded-full border-4 border-[#006c45] border-b-transparent animate-spin" style={{ animationDirection: 'reverse', animationDuration: '2s' }} />
        ...
        {step === 'success' && (
          ...
          >
            ...
            <div className="absolute inset-0 pointer-events-none opacity-25 overflow-hidden">
              ...
              <div className="absolute w-3 h-3 bg-blue-500 rounded-full bottom-1/3 left-1/3 animate-ping" style={{ animationDelay: '0.8s' }} />
            </div>

            <div className="text-center pt-6 mb-6">
              <div className="w-16 h-16 bg-[#67f9b3]/20 border border-[#67f9b3] rounded-full flex items-center justify-center mx-auto mb-4">
                <CheckCircle2 className="h-10 w-10 text-[#007149]" />
              </div>
              <h2 className="text-2xl font-black text-[#002645]">Payment Received!</h2>
              <p className="text-xs text-[#007149] font-bold mt-1">Transaction Completed Successfully</p>
            </div>
