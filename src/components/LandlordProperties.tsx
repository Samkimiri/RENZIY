                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1 flex flex-col justify-between py-1">
                      ...
                      <div className="flex items-center justify-between mt-2 pt-1 border-t border-dashed border-[#e4e2e4]">
                        <span className="text-[10px] font-bold px-2 py-0.5 bg-[#67f9b3]/20 text-[#007149] rounded-full">
            ...
            <div className="bg-white rounded-3xl shadow-sm border border-[#e4e2e4] overflow-hidden">
              ...
              <div className="p-6 border-b border-[#e4e2e4] bg-[#f0edef]/30 flex flex-col sm:flex-row justify-between sm:items-end gap-4">
                ...
                <div className="text-left sm:text-right bg-white p-3 rounded-xl border border-[#e4e2e4] shadow-xs shrink-0 flex items-center gap-3">
                  <div className="bg-[#67f9b3]/20 p-2 rounded-lg">
                    <Sparkles className="h-4 w-4 text-[#007149]" />
                  </div>
                  <div>
                        ...
                        <tr key={u.id} className="hover:bg-slate-50/50 transition-colors">
                          ...
                          <td className="px-6 py-4">
                            {isEditing ? (
                              ...
                              <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-bold ${u.status === 'Occupied' ? 'bg-[#67f9b3]/20 text-[#007149]' : 'bg-red-100 text-red-700'}`}>
                                {u.status}
                              </span>
                            )}
                          </td>
                            ...
                            {isEditing ? (
                              <div className="flex gap-2 justify-end">
                                <button 
                                  ...
                                  className="p-1 rounded bg-[#006c45]/10 text-[#006c45] hover:bg-[#006c45]/20"
